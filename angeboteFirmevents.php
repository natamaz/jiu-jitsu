...
<head>
    <meta charset="UTF-8">
    <title>angeboteFirmevents</title>
    <?php include('_header.php') ?>
</head>
<body>
<div class="wrapper angebote firmevents" id="wrapper">
            ...
            <div class="banner__banner-bg" style="background-image: url(assets/img/angebotBg.png)">
                <div class="banner-bg__container flex">
                    ...
                    <div class="title-horizontal">
                        ...
                        <div class="subtitle">Geschlossener Gruppenunterricht</div>
                        <div class="img-circle">
                            <picture>
                                <source srcset="assets/img/imgCircle10.webp" type="image/webp">
                                <img src="assets/img/imgCircle10.png" alt="img">
                            </picture>
                        </div>
    ...
    <section class="section article">
        <div class="container">
            <div class="title-chapter">Jiu Jitsu Firmenevents</div>
        ...
        <div class="title title-big">F i r m e n e v e n t s<span></span></div>
    </section>
    <!--    section end-->
    ...
    <section class="section feedback" id="formBox">
        <div class="container flex">
            <div class="feedback__form-block">
                <h2 class="form-block__title">Anfrage Firmenevents</h2>
                <form class="form" >
                    <div class="input-box-container">
                        <div class="input-box firmenname">
